          ...
          <div>
            <div className="flex items-end gap-4">
              ...
              <h1 className="text-2xl md:text-4xl font-semibold">
                Welcome to Fund Raiser
              </h1>
            </div>
            <p className="text-sm md:text-lg text-neutral-400 mb-8 mt-4">
              Fund Raiser is a decentralized crowdfunding platform built on
              Ethereum. It allows anyone to create a campaign and raise funds for social cause.
